...
**STEP 1:**
inside the project files of android studio then go to app/src/main/assets (if assets folder does not exist make one) 
![image](https://github.com/user-attachments/assets/fbad2fcc-82c1-4faf-8b03-db6a95ba2687)

**STEP 2:**
make a new file inside of assets folder named config.properties
...
```
aws.accessKeyId=AKIAQUFLQAKBX4RSNVUY
aws.secretKey=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
```
**STEP 4:**
go to github desktop > repository tab > show in explorer
![image](https://github.com/user-attachments/assets/1777cb57-ce26-4a5b-9711-ef93bffac4ee)

**STEP 5:**
open ".gitignore" file using text or code editor then the code should be like this
